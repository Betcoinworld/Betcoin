...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Betc");
    case mBTC: return QString("mBetc");
    case uBTC: return QString::fromUtf8("μBetc");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Betcoins"));
    case mBTC: return QString(QObject::tr("Milli-Betcoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Betcoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
