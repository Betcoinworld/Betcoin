Betcoin-qt: Qt4 GUI for Betcoin
===============================
...
Alternatively, install Qt Creator and open the `Betcoin-qt.pro` file.

An executable named `Betcoin-qt` will be built.
...
A warning for people using the *static binary* version of Betcoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of Betcoin is linked against libdb5.3.
...
installed causes Betcoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
